...
DROP VIEW view_usuarioCargo;
DROP VIEW view_ventaUsuario;
DROP VIEW view_DetalleVenta;
...
----------------------------------------
--DDL for Table SEGUIMIENTOENVIOS
----------------------------------------
...
-- USUARIOS
INSERT INTO usuario (idusuario, username, password, nombre, apellidos, rut, email, fechanac, telefono, direccion, comuna, region, rol_idrol) VALUES (1, 'mau.nunezv', '123123', 'Mauricio', ' Jimenez Vega', '18525378-0', 'mauro_1982@gmail.com', '13/08/1995', 935488947, 'palena 2320', 'peña blanca', 'Valparaiso', 1);
INSERT INTO usuario (idusuario, username, password, nombre, apellidos, rut, email, fechanac, telefono, direccion, comuna, region, rol_idrol) VALUES (2, 'juanReal', '987987', 'Juan', ' Real Cornelio', '20010740-3', 'Juan.real.cornelio@live.com', '25/01/1980', 88164075, 'Huanhualli', 'Villa Alemana', 'Valparaiso', 2);
INSERT INTO usuario (idusuario, username, password, nombre, apellidos, rut, email, fechanac, telefono, direccion, comuna, region, rol_idrol) VALUES (3, 'MargaritaCarmen', '123456', 'Margarita', ' Carmen Urrieta', '14298876-0', 'MargaritaCarmen@gmail.com', '11/04/1997', 936210874, 'Sur 140', 'Limache', 'Valparaiso', 3);
